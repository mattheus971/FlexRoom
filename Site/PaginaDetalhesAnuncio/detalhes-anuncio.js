document.addEventListener('DOMContentLoaded', () => {
  ...
  if (anuncio && usuarioAnunciante) {
    ...
    document.getElementById('tamanho').textContent = anuncio.tamanho || 'Não especificado';
    ...
    document.getElementById('garagens').textContent = anuncio.garagens || 'Não especificado';
